...
def savings(gross_pay, tax_rate, expenses):
    ...
    remainder_savings = after_tax-expenses
    return remainder_savings

print(savings(5000, 0.1, 500))
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    waste1 = str(waste)
    unit = str(material_units)
    final = waste1 + unit
    return final 

print(material_waste(100,"kg",4,20))
...
def interest(principal, rate, periods):
    ...
    final = math.floor(simple_interest)
    return final

print (interest(5000,0.03,2))
...
def body_mass_index(weight, height):
    ...
    height1 = list(height)
    height_foot = height1[0]*0.3048
    height_inch = height1[1]*0.0254
    height_meter = height_inch + height_foot
    height2 = height_meter**2
    bmi=weight_kg/height2
    return bmi
